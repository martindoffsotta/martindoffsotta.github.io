...
<div class="caption">
    Typical HT topology. A conventional transformer (red) is augmented with power electronics devices (green), providing advanced control capabilities for voltage regulation, harmonic suppression, and reactive power management.
</div>
