...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/vogi1.png" title="transition" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Transition of a tiltrotor eVTOL aircraft. 
</div>
